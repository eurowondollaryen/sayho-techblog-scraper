...
exports.getPostList = async function(parameters) {
	...
	+ "FROM ICTPOSTS WHERE BLOG_ID = (SELECT BLOG_ID FROM ICTBLOGS WHERE ROUTE = $1) ORDER BY INST_DT DESC, POST_SEQ ASC", parameters)
...
exports.postPostList = async function(parameters) {
	...
	+ "WHERE A.ROWNUM BETWEEN $2 + 1 AND $2 + 10 ORDER BY INST_DT DESC, POST_SEQ ASC", parameters)
	.then(function(res) { list = res.rows;});
	return list;
}