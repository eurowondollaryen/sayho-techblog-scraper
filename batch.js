...
const scraping = async function () {
    ...
    */
    ...
    (async () => {
        ...
        console.log(global_urls[0]["blog_id"] + " - " + global_urls[0]["title_en"] + " insert completed!");
    });
    ...
    try {
        ...
        console.log(global_urls[1]["blog_id"] + " - " + global_urls[1]["title_en"] + " insert completed!");
    }
    ...
    try {
        ...
        console.log(global_urls[2]["blog_id"] + " - " + global_urls[2]["title_en"] + " insert completed!");
    }
    ...
    (async () => {
        ...
        $bodyList.each(function(i, elem) {
            ulList[i] = {
                ...
                post_url: global_urls[3]["base_url"] + $(this).find("h2.post-title").find("a").attr("href"),
        ...
        console.log(global_urls[3]["blog_id"] + " - " + global_urls[3]["title_en"] + " insert completed!");
    });
    ...
    (async () => {
        ...
        console.log(global_urls[4]["blog_id"] + " - " + global_urls[4]["title_en"] + " insert completed!");
    });
    ...
    (async () => {
        ...
        console.log(global_urls[5]["blog_id"] + " - " + global_urls[5]["title_en"] + " insert completed!");
    });
    ...
    try {
        ...
        console.log(global_urls[6]["blog_id"] + " - " + global_urls[6]["title_en"] + " insert completed!");
    }
    ...
    try {
        ...
        console.log(global_urls[7]["blog_id"] + " - " + global_urls[7]["title_en"] + " insert completed!");
    }
    ...
    try {
        ...
        console.log(global_urls[8]["blog_id"] + " - " + global_urls[8]["title_en"] + " insert completed!");
    }
    ...
    try {
        ...
        console.log(global_urls[9]["blog_id"] + " - " + global_urls[9]["title_en"] + " insert completed!");
    }
    ...
    try {
        ...
        console.log(global_urls[10]["blog_id"] + " - " + global_urls[10]["title_en"] + " insert completed!");
    }
